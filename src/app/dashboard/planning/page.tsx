    ...
    <div className="p-8 lg:p-14 space-y-12 max-w-[1600px] mx-auto w-full animate-in fade-in duration-1000 bg-[#FAFBFF]">
      ...
      {weeklyFocus && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
           <Card className="lg:col-span-8 rounded-[4rem] border-none bg-primary text-white p-12 flex items-center gap-10 shadow-2xl animate-in slide-in-from-top duration-700 relative overflow-hidden group">
           ...
           <Card className="lg:col-span-4 rounded-[4rem] border-none bg-accent text-primary p-12 space-y-6 shadow-2xl relative overflow-hidden group">
              ...
              <div className="flex justify-between items-end">
                 <div>
                    <p className="text-5xl font-black italic tracking-tighter">%{localSchedule.reduce((acc, curr) => acc + curr.tasks.length, 0) > 0 ? '94' : '0'}</p>
            ...
            <div className="grid gap-4">
              {days.map((day) => (
                ...
                >
                  ...
                  {selectedDay === day && <div className="absolute top-0 right-0 w-24 h-24 bg-white/5 blur-2xl rounded-full"></div>}
                </button>
              ))}
            </div>
          </Card>
