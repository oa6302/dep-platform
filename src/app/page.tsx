  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] selection:bg-accent selection:text-white overflow-x-hidden">
      ...
      <main className="pt-32 pb-20">
        ...
        <section className="mt-40 relative w-full px-4 md:px-10">
          <div className="bg-primary rounded-[3rem] md:rounded-[5rem] overflow-hidden group shadow-2xl py-24 md:py-32">
            ...
            <div className="container mx-auto grid lg:grid-cols-2 gap-20 items-center relative z-10 px-6 md:px-12">
              <div className="space-y-10 text-white text-center lg:text-left">
                 <h2 className="text-4xl md:text-7xl lg:text-8xl font-black italic tracking-tighter leading-[0.85] uppercase text-shadow-premium">Maksimum <br /><span className="text-accent text-shadow-accent">Odaklanma</span></h2>
                 <p className="text-lg md:text-2xl text-white/80 font-medium leading-relaxed italic max-w-xl">
